...
export const ABOUT_SECTIONS = {
  ...
  howto: {
    ...
    quickStart: [
      ...
      "Use the census data overlays (Pop./Jobs/Transit) to add demographic context. Population density shows where people live, job density shows where they work, and transit commute share highlights areas where residents actually depend on public transit. Hover any tract for exact numbers. I like to have commuter rail and subway turned on to see how the network is serving different areas.",
