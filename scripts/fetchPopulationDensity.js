...
const CITY_CONFIGS = {
  ...
  boston: {
    ...
    counties: [
      [STATE.MA, "001", "Barnstable County"],
      [STATE.MA, "005", "Bristol County"],
      [STATE.MA, "007", "Dukes County"],
      [STATE.MA, "025", "Suffolk County"],
      [STATE.MA, "017", "Middlesex County"],
      [STATE.MA, "019", "Nantucket County"],
      [STATE.MA, "021", "Norfolk County"],
      [STATE.MA, "023", "Plymouth County"],
      [STATE.MA, "027", "Worcester County"],
      [STATE.MA, "009", "Essex County"],
      [STATE.RI, "001", "Bristol County (RI)"],
      [STATE.RI, "005", "Newport County (RI)"],
      [STATE.RI, "003", "Kent County (RI)"],
      [STATE.RI, "007", "Providence County (RI)"],
      [STATE.RI, "009", "Washington County (RI)"],
    ],
  },
  philly: {
  ...
  denver: {
    ...
    counties: [
      ...
      [STATE.CO, "014", "Broomfield County"],
